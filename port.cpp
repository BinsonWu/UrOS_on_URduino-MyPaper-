...
portSTACK_TYPE *pxPortInitialiseStack( portSTACK_TYPE *pxTopOfStack, pdTASK_CODE pxCode, void *pvParameters )
{
	...
	uTaskSR |= (SPR_SR_TEE | SPR_SR_IEE | SPR_SR_IME | SPR_SR_DME);		// Tick interrupt enable, All External interupt enable
...
prvSetupTimerInterrupt();
		...
		"   l.movhi	r3, hi(_TaskRunning)		\n\t"
		"   l.ori	r3, r3, lo(_TaskRunning)	\n\t"
		"   l.lwz	r3, 0x0(r3)		\n\t"
		"   l.lwz	r1, 0x0(r3)		\n\t"
		/*   restore context               	*/
		"   l.lwz	r9,  0x00(r1)	\n\t"
